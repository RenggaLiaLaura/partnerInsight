                            ...
                            <tr x-show="expanded" class="bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 border-b border-gray-100 dark:border-gray-700 last:border-b-0" style="display: none;">
                                ...
                                <td class="px-6 py-3 text-center">
                                    <div class="flex items-center justify-center gap-2">
                                        ...
                                        <form action="{{ route('sales.destroy', $sale->id) }}" method="POST" class="inline-block delete-form" data-confirm-title="Hapus Data Penjualan?" data-confirm-text="Data penjualan akan dihapus permanen!">
                                            @csrf
                                            @method('DELETE')
