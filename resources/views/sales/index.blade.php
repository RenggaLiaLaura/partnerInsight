...
<div class="mb-6">
    <div class="flex flex-col md:flex-row items-center justify-between">
        ...
        <div class="flex gap-3">
            ...
            <a href="{{ route('sales.create') }}" class="inline-flex items-center p-2 md:px-4 md:py-2 text-sm font-medium text-white bg-brand-600 rounded-lg hover:bg-brand-700 focus:ring-4 focus:ring-brand-300 dark:bg-brand-600 dark:hover:bg-brand-700 focus:outline-none dark:focus:ring-brand-800 shadow-sm transition-colors duration-200">
                ...
                <span class="hidden md:inline">Add Sales Data</span>
            </a>
            @endif
            ...
            <div x-data="{ open: false }" class="relative">
                ...
                <div x-show="open" x-cloak @click.away="open = false" x-transition class="absolute right-0 z-10 mt-2 w-56 rounded-md shadow-lg bg-white dark:bg-gray-700 ring-1 ring-black ring-opacity-5">
                    <div class="py-1">
                        @if(Auth::user()->role !== 'manager')
                        <a href="{{ route('sales.import') }}" class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-600">
                        ...
                        @if(Auth::user()->role !== 'manager') <hr class="my-1 border-gray-200 dark:border-gray-600"> @endif
    ...
    init() {
        this.$watch('searchQuery', (value) => {
            ...
            this.debounce = setTimeout(() => {
                fetch('{{ route('sales.index') }}?search=' + value, {
                    headers: {
                ...
                .then(html => {
                    document.getElementById('sales-table-container').outerHTML = html;
