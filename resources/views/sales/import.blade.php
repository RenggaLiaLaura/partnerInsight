...
<div class="mb-6">
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Import Sales Data</h1>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Upload Excel file to bulk import sales performance data.</p>
        </div>
    </div>
</div>
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
    ...
    <div class="bg-white border border-gray-100 rounded-xl shadow-sm dark:bg-gray-800 dark:border-gray-700 p-6">
        ...
        <form action="{{ route('sales.import.process') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="mb-4">
    ...
    <div class="bg-white border border-gray-100 rounded-xl shadow-sm dark:bg-gray-800 dark:border-gray-700 p-6">
        ...
        <ol class="space-y-3 text-sm text-gray-600 dark:text-gray-400">
            ...
            <li class="flex items-start">
                ...
                <span>Fill in your sales data following the format</span>
            </li>
            <li class="flex items-start">
        ...
        <div class="mt-6 pt-6 border-t border-gray-100 dark:border-gray-700">
            <a href="{{ route('sales.template') }}" class="flex items-center justify-center text-brand-600 hover:text-brand-700 dark:text-brand-400 dark:hover:text-brand-300 font-medium text-sm">
