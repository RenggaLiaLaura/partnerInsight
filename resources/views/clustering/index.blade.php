...
<div class="mb-6">
    <div class="flex flex-col md:flex-row items-center justify-between">
        ...
        <div class="flex space-x-3">
            @if($results->count() > 0)
            <a href="{{ route('clustering.report') }}" target="_blank" class="inline-flex items-center p-2 md:px-4 md:py-2 text-sm font-medium text-brand-600 bg-white border border-brand-600 rounded-lg hover:bg-brand-50 focus:ring-4 focus:outline-none focus:ring-brand-300 dark:bg-gray-800 dark:text-brand-400 dark:border-brand-400 dark:hover:bg-gray-700">
